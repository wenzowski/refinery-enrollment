class CreateRefineryEnrollmentStructure < ActiveRecord::Migration
  def change
    ...
    create_table Refinery::Enrollment::OfferedCourse.table_name do |t|
      t.integer :course_id, :null => false
      t.integer :session_id, :null => false

      t.timestamps
    end
    add_index Refinery::Enrollment::OfferedCourse.table_name, :id
    add_index Refinery::Enrollment::OfferedCourse.table_name, :course_id
    add_index Refinery::Enrollment::OfferedCourse.table_name, :session_id
    ...
    create_table Refinery::Enrollment::GuardianRelationship.table_name do |t|
      t.integer :student_id, :null => false
      t.integer :guardian_id, :null => false

      t.timestamps
    end
    add_index Refinery::Enrollment::GuardianRelationship.table_name, :id
    add_index Refinery::Enrollment::GuardianRelationship.table_name, :student_id
    add_index Refinery::Enrollment::GuardianRelationship.table_name, :guardian_id

    create_table Refinery::Enrollment::Registration.table_name do |t|
      t.integer :offered_course_id, :null => false
      t.integer :student_id, :null => false

      t.timestamps
    end
    add_index Refinery::Enrollment::Registration.table_name, :id
    add_index Refinery::Enrollment::Registration.table_name, :offered_course_id
    add_index Refinery::Enrollment::Registration.table_name, :student_id
